...
from keras.layers import LSTM, GRU # you can also try using GRU layers
...
trg_data_root = "C:\\Users\\DELL\\Desktop\\LSTM-KTH\\Data\\"
...
print ("Loading data")
# load training data
X_train, y_train = load_data_for_persons(trg_data_root, 21, 25, maxToAdd)
